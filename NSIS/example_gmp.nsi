...
!define SOURCEDIRECTORY "C:\temp\qt_static\testavcodec"
...
DirText "Setup will create subfolder Minh/MGMP and install Minh Media Player v0.1. To install in a different folder, click Browse button. Click Install to start the installation."
XPStyle on
...
file "${SOURCEDIRECTORY}\release\gmp.exe"
...
createShortCut "$SMPROGRAMS\${COMPANYNAME}\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\${COMPANYNAME}\${APPNAME}\gmp.exe" "" $INSTDIR\${COMPANYNAME}\${APPNAME}\topicon_XaE_icon.ico"
